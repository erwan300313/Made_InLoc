        ...
        <aside>
            ...
            <div class="comments_content">
                ...
                <div class="forumCommentContent">
                   <p><?=$comment['content']?></p>
                   <p class="deleteButton"><a href="index.php?controller=forum&amp;action=deleteComment&amp;comment_id=<?=$comment['id']?>&amp;topic_id=<?=$topic['id']?>">Supprimer ce commentaire définitivement</a></p>
                </div>
            </div>
        </aside>
    </article>
